...
#ifndef DPPS_FONT_VOLLKORN
#define DPPS_FONT_VOLLKORN
#include "fonts_declarations.hh"

namespace dpps {
alphabet_iso8859_1_raw Vollkorn_Normal_0 {{
    DPPS_33_EMPTY_CHARACTERS
    #include "data_Vollkorn-Normal_0.txt"
}} ;
alphabet_iso8859_1_raw Vollkorn_Bold_0 {{
    //#include "data_Vollkorn-Bold_0.txt"
}} ;
alphabet_iso8859_1_raw Vollkorn_Italic_0 {{
    //#include "data_Vollkorn-Italic_0.txt"
}} ;
alphabet_iso8859_1_raw Vollkorn_Bold_Italic_0 {{
    //#include "data_Vollkorn-Bold-Italic_0.txt"
}} ;
alphabet_iso8859_1_raw Vollkorn_Normal_1 {{
    //#include "data_Vollkorn-Normal_1.txt"
}} ;
alphabet_iso8859_1_raw Vollkorn_Bold_1 {{
    //#include "data_Vollkorn-Bold_1.txt"
}} ;
alphabet_iso8859_1_raw Vollkorn_Italic_1 {{
    //#include "data_Vollkorn-Italic_1.txt"
}} ;
alphabet_iso8859_1_raw Vollkorn_Bold_Italic_1 {{
    //#include "data_Vollkorn-Bold-Italic_1.txt"
}} ;
} // namespace dpps
