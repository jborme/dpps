...
class Pattern_text: public Pattern {
    ...
    public:
        ...
        /** @brief the name of the font. It refers the radical of a filemane in
         * the font_data/ directory. Currenlty it can be "Vollkorn",
         * "Source Sans Pro" or "Source Code Pro".
         */
        std::string font_name {"Vollkorn"} ;
...
public:
     ...
     *
    short unsigned int choose_variant (const std::string &font_name, const bool italic, const short unsigned int thickness) ;*/
